...
@#$#@#$#@
## TODO
-Create graph where you run it over and over and see what the end alive populations end up being shoot  100. 
-Make model with 4 water holes where people barely go to different water holes
